...
check("wallpaper element present", w.document.querySelector(".wallpaper") !== null);
check("companion system loaded", Boolean(w.CoReadCompanion));
check("room computer present", Boolean(w.document.querySelector("#roomComputer")));
check("room props present", w.document.querySelectorAll(".room-prop").length >= 3);
